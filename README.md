...
Status: deployed as a **gated private beta** — login required while we validate scan accuracy (`my-shoe-fit.lovable.app`). No open public demo yet.
